                ...
                <div class="footer-widget">
                    <a href="index.php" style="text-decoration: none; display: flex; align-items: center; margin-bottom: 20px;">
                        <div style="display: flex; align-items: center; font-family: sans-serif;">
                            <div style="background: #ffb700; color: #000; padding: 5px 12px; border-radius: 4px; font-weight: 900; font-size: 22px; margin-right: 10px;">DD</div>
                            <div style="color: #fff; font-weight: 700; font-size: 22px; letter-spacing: 1px; text-transform: uppercase;">JAIN</div>
                        </div>
                    </a>
